...
st.caption("Ön ödeme kuralı (%50 Min) ve araç kiralama bakiyelerinin takibi.")
st.divider()
...
if selected_option != "--- Seçiniz ---":
    ...
    if remaining_balance > 0:
        ...
        # Ödeme başarılıysa: kalıcı olarak (rerun ile kaybolmadan) başarı mesajı + fatura indirme butonu göster
        ...
        if pending and pending["contract_no"] == contract_no:
            ...
            if st.button("🔄 Sayfayı Yenile (Güncel Bakiyeyi Göster)"):
