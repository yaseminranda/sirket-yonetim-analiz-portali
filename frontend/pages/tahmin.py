...
# departmanı D3 (şirket geneli) olmayan bir "Genel Müdür" (örn. Araç/Ev
# departmanının Genel Müdürü) bu sayfaya erişememeli. bkz. Home.py'deki
# is_genel_mudur_d3 ile aynı kural.
...
st.caption("Gelecek Dönem Ciro/Talep Tahmini, İptal Riski Analizi ve Filo/Gayrimenkul Yatırım Öneri Sistemi")
st.divider()
...
with tab2:
    ...
    st.caption("Parametreleri girerek yapay zekânın iptal olasılığını hesaplamasını sağlayabilirsiniz.")
...
with tab3:
    ...
    st.caption("Anlık doluluk oranları ve talep yoğunluğu analiz edilerek üretilen yatırım tavsiyeleridir.")
