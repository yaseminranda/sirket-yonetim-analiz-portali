...
st.caption(
    "Her ay için o ayda BAŞLAYAN sözleşmelerin toplam tutarı 'ciro' olarak alınır. "
    "Net kâr, o ayki ciro - güncel toplam aylık maaş gideri olarak hesaplanır."
)
...
if df_v_trend.empty and df_h_trend.empty:
    ...
    # Kümülatif (birikimli) toplam HER ZAMAN tüm geçmiş veri üzerinden
    # hesaplanır -- aşağıdaki tarih aralığı sadece hangi ayların GÖRÜNTÜLENECEĞİNİ
    # kırpar, toplamın kendisini değiştirmez. Aksi halde aralığı daralttığınızda
    # kümülatif çizgi yanlışlıkla sıfırdan başlamış gibi görünürdü.
    ...
    st.caption("📅 Aşağıdaki tarih aralığı sadece grafiklerde gösterilen ayları filtreler; Kümülatif toplam yine de tüm geçmişi kapsar.")
...
st.caption("Bu bölüm sadece D3/Yönetici seviyesindeki kullanıcıların giriş hareketlerini içerir.")
